...
#haverão mudançass nos módulos futuramente para pensar melhor na produção. 
#essas mudanças potencialmente incluem:
#   - unificar os módulos de phash e do clip para avaliar imagens
#   - retirar algumas funções atuais (não são muitas) 
#  
